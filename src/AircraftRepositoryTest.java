...
class AircraftRepositoryTest {
    ...
    void aircraftExists() {
        Aircraft aircraft = new Aircraft("Model Exists", "SNEXISTS123", "Active", "Existence Test Mission", "Pilot" +
                " " +
                "Exists", new Date());
        Aircraft aircraft2 = new Aircraft("Model Exists 2", "SNDOESNOTEXIST", "Active", "Existence Test Mission",
                "Pilot" +
                " " +
                "Exists", new Date());
    ...
    void addAircraft() {
        Aircraft aircraft = new Aircraft("Model Add", "SNADD123", "Active", "Add Test Mission", "Pilot Add", new Date());
        aircraftRepository.addAircraft(aircraft);
    ...
    void removeAircraft() {
        Aircraft aircraft1 = new Aircraft("Model Remove1", "SNREMOVE123", "Active", "Remove Test Mission", "Pilot " +
                "Remove", new Date());
        aircraftRepository.addAircraft(aircraft1);

        Aircraft aircraft2 = new Aircraft("Model Remove2", "SNREMOVE1234", "Active", "Remove Test Mission", "Pilot " +
                "Remove", new Date());
        aircraftRepository.addAircraft(aircraft2);

        Aircraft aircraft3 = new Aircraft("Model Remove3", "SNREMOVE12345", "Active", "Remove Test Mission", "Pilot " +
                "Remove", new Date());
    ...
    void updateAircraft() {
        Aircraft aircraft = new Aircraft("Model Update", "SNUPDATE123", "Inactive", "Update Mission", "Pilot Update", new Date());
        aircraftRepository.addAircraft(aircraft);
        aircraftRepository.updateAircraft("SNUPDATE123", "Updated Model", "SNUPDATE123", "Active", "Updated Mission",
                "Updated Pilot", new Date());
    ...
    void getAllAircraft() {
        Aircraft aircraft1 = new Aircraft("Model 1", "SN1", "Active", "Mission 1", "Pilot 1", new Date());
        Aircraft aircraft2 = new Aircraft("Model 2", "SN2", "Inactive", "Mission 2", "Pilot 2", new Date());
        aircraftRepository.addAircraft(aircraft1);
        aircraftRepository.addAircraft(aircraft2);
    ...
    void getAircraftBySerialNumber() {
        Aircraft aircraft = new Aircraft("Model Get", "SNGET123", "Active", "Get Test Mission", "Pilot Get", new Date());
        aircraftRepository.addAircraft(aircraft);
    ...
    void deleteAllAircraft() {
        Aircraft aircraft = new Aircraft("Model Delete All", "SNDELETEALL123", "Active", "Delete All Test Mission", "Pilot Delete All", new Date());
        aircraftRepository.addAircraft(aircraft);
        aircraftRepository.deleteAllAircraft();
        List<Aircraft> aircraftList = aircraftRepository.getAllAircraft();
